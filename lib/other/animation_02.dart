...
//    4、监听动画状态改变
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(child: RYAnimationIcon(animation)),
...
class RYAnimationIcon extends AnimatedWidget {
//  final Animation _sizeAnimation;
  RYAnimationIcon(Animation _sizeAnimation): super(listenable: _sizeAnimation);
